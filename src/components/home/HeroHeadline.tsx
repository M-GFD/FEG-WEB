...
/** Paleta FEG para la banda del reveal sobre el hero oscuro. */
...
export function HeroHeadline({
  ...
  return (
    <div className="mx-auto max-w-2xl text-center">
      ...
      <p className="mx-auto mt-4 max-w-xl text-[0.95rem] font-medium leading-relaxed [text-shadow:0_1px_10px_rgba(0,0,0,0.42)] sm:text-base sm:leading-normal md:text-lg">
        <DiaTextReveal
          text={subtitle}
          textColor="#FFFFFF"
          colors={HERO_REVEAL_COLORS}
