...
export interface DiaTextRevealProps
  ...
  startOnView?: boolean;
  /** If `true`, in-view detection fires at most once. @defaultValue `true` */
  once?: boolean;
  className?: string;
  /**
   * When `text` has multiple entries, use the widest string’s width for layout.
   * @defaultValue `false`
   */
  fixedWidth?: boolean;
}
...
/**
 * Dia Text Reveal (Magic UI): banda de color que barre el texto y deja el color base.
...
export function DiaTextReveal({
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- medir al cambiar el copy
