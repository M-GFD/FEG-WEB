...
import { REGLAMENTOS } from "@/lib/reglamentos";
    ...
    <div className="min-h-screen bg-[var(--feg-bg)] text-[var(--feg-ink)]">
      ...
      <main className="mx-auto max-w-7xl px-6 py-14 lg:px-8">
        ...
        <header className="mt-6 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 max-w-2xl text-base font-medium leading-relaxed text-[var(--feg-green)] sm:text-lg">
              Normativas vigentes de la Federación Entrerriana de Golf para la temporada 2026.
            </p>
          </div>
        ...
        <ReglamentosHub
          ...
          detailBasePath="/institucional/reglamentos"
        />
      </main>
    </div>
  );
